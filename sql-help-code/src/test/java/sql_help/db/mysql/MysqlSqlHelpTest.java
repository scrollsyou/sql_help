...
public class MysqlSqlHelpTest {
	...
	public void getSqlToSelectCount() throws Exception {
		MysqlSqlHelp help = new MysqlSqlHelp();
		System.out.println(help.getSqlToSelectCount(BeanWrapper.instrance(StudentVo.class, new GlogalConfig()), true));
	}
	
	@Test
	public void getSqlToSelectByVo() throws Exception {
		MysqlSqlHelp help = new MysqlSqlHelp();
		System.out.println(help.getSqlToSelect(BeanWrapper.instrance(StudentVo.class, new GlogalConfig()), true));
	}
